        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4 sm:col-span-2 md:col-span-1">
            <div className="flex items-center space-x-3">
              <img src={logo} alt="FranchiseLeadsPro Logo - Franchise Lead Generation Experts" width="40" height="40" <img src={logo} alt="FranchiseLeadsPro Logo - Franchise Lead Generation Experts" width="56" height="56" className="w-14 h-14 object-contain" /> />
          ...
          <div className="space-y-4 sm:col-span-2 md:col-span-1">
            ...
            <div className="space-y-3 text-gray-400">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+15512012377" className="hover:text-white transition-colors">+1 (551)-201-23-77</a>
              </div>
