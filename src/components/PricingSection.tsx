      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Everything you need to generate franchise leads — starting at just $899/month.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="relative border-2 border-primary shadow-elegant overflow-hidden">
            ...
            <CardHeader className="text-center pb-2">
              ...
              <div className="mt-4">
                <span className="text-5xl font-extrabold text-foreground">$899</span>
            ...
            <CardContent className="pt-6">
              ...
              <div className="mt-8 pt-6 border-t border-border">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-extrabold text-foreground">$799<span className="text-sm font-normal text-muted-foreground">/mo</span></span>
                </div>
              </div>
